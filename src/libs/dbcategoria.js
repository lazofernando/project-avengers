...
async function actualizarCategoria(categoria) {
  try {
    let pool = await sql.connect(config);
    let Updatecategorias = await pool
      .request()
      //estos son los parametros del store procedure
...
async function insertarProveedor(proveedor) {
  try {
    let pool = await sql.connect(config);
    let InsertProveedor = await pool
      .request()
      //estos son los parametros del store procedure
...
async function actualizarProveedor(proveedor) {
  try {
    let pool = await sql.connect(config);
    let UpdateProveedor = await pool
      .request()
      //estos son los parametros del store procedure
...
async function eliminarCategoria(categoria) {
  try {
    let pool = await sql.connect(config);
    let DeleteCategorias = await pool
      .request()
      //estos son los parametros del store procedure
      .input("idCategoria", sql.Int, categoria.idCategoria)
...
async function eliminarProveedor(proveedor) {
  try {
    let pool = await sql.connect(config);
    let DeleteProveedor = await pool
      .request()
      //estos son los parametros del store procedure
      .input("idProveedor", sql.Int, proveedor.idProveedor)
...
async function eliminarUsuario(usuario) {
  try {
    let pool = await sql.connect(config);
    let DeleteUsuario = await pool
      .request()
      //estos son los parametros del store procedure
      .input("idUsuarios", sql.Int, usuario.idUsuarios)
      .execute("DELETE_USUARIO");
    return DeleteUsuario.recordsets;
  } catch (error) {
    console.log(error);
  }
}
